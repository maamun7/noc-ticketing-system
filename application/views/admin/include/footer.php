...
<!-- Ad, you can remove it -->
    ...
    <footer class="row">
		<div id="main" class="col-md-11">
			<p class="col-md-9 col-sm-9 col-xs-12 copyright">Cellex Limited &copy; <a href="http://cellexltd.com/" target="_blank"></a><?php echo date('d/M/Y') ?></p>

			<p class="col-md-3 col-sm-3 col-xs-12 powered-by">Powered by: <a href="http://logic-thought.com/">Logic & Thoughts</a></p>
		</div>
   </footer>
<?php } ?>