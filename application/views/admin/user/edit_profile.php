    ...
    <div class="box col-md-12">
		<div class="box-inner" style="overflow:auto;">
			...
			<div class="box-content">
				<form action="<?=base_url()?>dashboard/update_profile" id="edit_profile" method="post"  name="edit_profile" enctype="multypart/formdata">
					<div class="col-md-12 well">
						...
						<div class="col-md-6 well">	
							...
							<div class="form-group">
								...
								<input type="text" placeholder="Designation" class="form-control" id="designation" name="designation" value="{designation}" calss="required" required  />
							</div>								
