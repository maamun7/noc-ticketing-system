							...
							<div class="box-content">
								...
								<div class="form-group has-primary col-md-12">
									...
									<select class="form-control" name="send_type" >
                                        ...
                                        <?php if ($view_open_options) { ?>
										<option value="3" <?php if(isset($send_type_value) && $send_type_value =="3"){ echo "selected='selected'"; } ?> >Open</option>
										<?php } ?>
                                        <option value="2" <?php if(isset($send_type_value) && $send_type_value =="2"){ echo "selected='selected'"; } ?> >On going</option>
										<option value="1" <?php if(isset($send_type_value) && $send_type_value =="1"){ echo "selected='selected'"; } ?> >Done</option>
									</select>
								</div>
